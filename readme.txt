...
Contributors: Dilip kumar, Tagwebs Technologies Pvt. Ltd
Donate link: http://www.uholder.com/
Author URI: http://www.uholder.com/
Plugin URI: http://www.uholder.com/
Tags: popup-contact-form,beautiful-popup-contact-form,beauty-contact-form,popup-contact,popup-form,contact-form,email-form,popup,popup-contact-form, contact,contact-us,contact-easy,email-us,email
...
This Contact Popup form plugin display popup form by clicking button or text link in the front end of the website. That contact popup form let user to send the emails to site admin.
